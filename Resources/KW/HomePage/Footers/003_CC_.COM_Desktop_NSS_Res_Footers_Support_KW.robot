...
Verify URL changes to Contact Us Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${CONTACT_US_URL}
...
Verify URL changes to Help Center Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${HELP_CENTER_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Order Status Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${ORDER_STATUS_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Trouble Ticket Status Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${TROUBLE_TICKET_STATUS_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Support Wizard Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${SUPPORT_WIZARD_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Test Your Speed Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${TEST_YOUR_SPEED_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Video Gallery Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${VIDEO_GALLERY_URL}
    Verify currnt URL  ${EXPECTED_URL}

...
Verify URL changes to Get Vantage Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${GET_VANTAGE_URL}
...
Verify URL changes to Frontier Secure Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${FRONTIER_SECURE_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Frontier BusinessEdge Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${FRONTIER_BUSINESSEDGE_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Frontier Games Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${FRONTIER_GAMES_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Frontier WI-FI Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${FRONTIER_WIFI_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Wholesale Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${WHOLESALE_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Frontier Yahoo Portal Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${FRONTIER_YAHOO_PORTAL_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Referral Program Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${REFERRAL_PROGRAM_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to BusinessEdge Partner Program Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${BUSINESSEDGE_PARTNER_PROGRAM_URL}
    Verify currnt URL  ${EXPECTED_URL}

...
Verify URL changes to Central Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${CENTRAL_URL}
...
Verify URL changes to East Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${EAST_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Mid-South Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${MID-SOUTH_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to National-IL,IA,MN,NE,UT Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${NATIONAL-IL-IA-MN-NE-UT_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to National-ID,MT Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${NATIONAL-ID-MT_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to South Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${SOUTH_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to Southeast Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${SOUTHEAST_URL}
    Verify currnt URL  ${EXPECTED_URL}
...
Verify URL changes to West Page
    ${EXPECTED_URL}  read_cell_data_by_Header_name   ${RES_EXCEL_PATH}  ${SHEET_NAME}   ${TESTCASE_NO}  ${WEST_URL}
    Verify currnt URL  ${EXPECTED_URL}

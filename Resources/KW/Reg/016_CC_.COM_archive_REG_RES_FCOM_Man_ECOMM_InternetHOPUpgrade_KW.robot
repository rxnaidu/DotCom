...
Verify user launches into Self Service Portal successfully
    ...
    wait until element is enabled  id=upgrade-internet-button  4m
    sleep  3s
...
#    Add Fios Internet 50/50 Mbps Product
    wait until element is enabled  xpath=//fecomm-price[@price="20"]/../following-sibling::div/button
    click element  xpath=//fecomm-price[@price="20"]/../following-sibling::div/button
...
Enter initial and click Complete order
    wait until element is enabled  xpath=//input[@ng-model="userInitials.initials"]  4m
...
#    set global variable  ${ORD_ID_DATA}
    ...
    #Order #070479864  Tel: 813-689-5758  -- 02/07
